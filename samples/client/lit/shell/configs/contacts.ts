...
export const config: AppConfig = {
  ...
  description:
    "Surface the right people instantly with fast filters and clean, shareable summaries.",
  ...
  suggestions: [
    "Design leadership in San Francisco.",
    "Customer success team in Toronto.",
    "Finance ops contacts in Berlin.",
  ],
  loadingText: [
    "Searching contacts...",
    "Looking up details...",
